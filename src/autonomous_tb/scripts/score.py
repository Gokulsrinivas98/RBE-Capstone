...
class Score():
	...
	def __init__(self):
		...
		self.FILE_PATH = "/home/febin/c_ws/src/autonomous_tb/maps/map.pgm"
	...
	def score(self, locations, goal, file_path):
		...
		return    : dictionary{start_coordinate: (path_length, path_nodes)} 
		"""
		# Load the map
		...
		for start_coord in locations:
			...
			score_dict["start_coord"] = (path_length, path_nodes)
		end_time = time.time()
