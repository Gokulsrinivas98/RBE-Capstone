...
class Score():
	...
	def __init__(self):
		...
		# Without obstacles
		self.FILE_PATH = "/home/aka/capstone_ws/src/autonomous_tb/maps/mmap.pgm"
		# With obstacles
		self.FILE_PATH2 = "/home/aka/capstone_ws/src/autonomous_tb/maps/mmap_cost_obs.pgm"
	...
	def score(self, locations, goal, file_path):
		...
		gradient_map = self.grad_map(map_array, risk_coordinates, kernel_size=50, sigma=0.6, max_cost=10) #increasing the kernel size of the gradient
